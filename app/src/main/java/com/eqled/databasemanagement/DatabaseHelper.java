...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    private static final String TABLE_NAME = "sqlite-program.db";
    ...
    public void onCreate(SQLiteDatabase database,
        ...
        try {
            ...
            TableUtils.createTable(connectionSource, TimeDateBean.class);
    ...
    public void onUpgrade(SQLiteDatabase database,
        ...
        try {
            ...
            TableUtils.dropTable(connectionSource, TimeDateBean.class, true);
    ...
    public synchronized Dao getDao(Class clazz) throws SQLException {
        ...
        if (dao == null) {
            dao = super.getDao(clazz);   //有疑问 按下不表
